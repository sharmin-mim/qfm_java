...
#	4. 	Command: perl all_method_simulation_bio.pl --folderName f
#		Here, f = folderName
...
my $stat_table_fname =  "/home/user/research/wqfmProject/table/wQFM/all_method_memory_statistics_biological_dataset.txt";
...
$astral_time, $astral_memory;

printf RESULT_TABLE  " %.2f %d",
$QMC_time, $QMC_memory;

printf RESULT_TABLE  " %.2f %d",
$wQMC_time, $wQMC_memory;
...
sub usage_and_help{
    print "USAGE:\n\n";
    print "all_method_simulation.pl --nTaxa n --folderName f --experiment r \n\n";   
    print "where\n";
