...
#Originally this script prints the FP rate, FN rate, and Robinson-Foulds distance of a pair of trees.
#We did a minor modification to print only the Robinson-Foulds distance (see line 53-54) 
###########################################################################
...
fp, fn, rf = getFpFnRfRates(trueTree, estimateTree)
print(rf)
