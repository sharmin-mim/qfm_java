...
#	 	This script generates all possible SVDquartets.
...
#	5. 	Command: perl sate_dataset_simulation_100taxa.pl -folder_name name  -rep_no n   
#		where,
#		name = folder name in the simulation (provide file name with full directory address),
#    	n = replicate number in the simulation.
...
print COMF "#NEXUS\n".
           "BEGIN PAUP;\n".
           "\tEXECUTE $nexus_file;\n".
           "\tsvdQuartets evalQuartets = all qfile=$quartet_file;\n".
...
print "Running writing statistics step ...\n";
#
...
sub usage_and_help{
    print "USAGE:\n\n";
    print "sate_dataset_simulation_100taxa.pl -folder_name name  -rep_no n \n\n";   
    print "where\n";
    print "\tname = folder name in the simulation\n";
    print "\tn = replicate number in the simulation\n";
