...
#	4. 	Command: perl all_method_simulation.pl --nTaxa n --folderName f --experiment r  
#	5. 	n = number of taxa in the simulation, f = folderName, r = replicate number
...
my $output_file_dir = "$parents_input_dir/${folderName}/R${experiment}";
